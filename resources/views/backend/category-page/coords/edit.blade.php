            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Co-Ords Details</li>
                </ol>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('co-ords.update', $coords_details->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT') 
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="banner_heading" type="text" name="banner_heading" value="{{ old('banner_heading', $coords_details->banner_heading) }}" placeholder="Enter Banner Heading" required>
                                    ...
                                    <div class="col-xxl-4 col-sm-12">
                                        ...
                                        <div id="currentImageContainer">
                                            @if($coords_details->banner_image)
                                                <img id="currentBannerImage" src="{{ asset('/murupp/category/coords/' . $coords_details->banner_image) }}" alt="Current Banner Image" style="max-height: 100px; border: 1px solid #ddd; padding: 5px;">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 text-end">
                                        <a href="{{ route('co-ords.index') }}" class="btn btn-danger px-4">Cancel</a>
