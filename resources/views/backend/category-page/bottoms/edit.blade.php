        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Bottoms Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('bottoms.index') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit Bottoms Details</li>
                </ol>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('bottoms.update', $bottoms_details->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="banner_heading" type="text" name="banner_heading" value="{{ old('banner_heading', $bottoms_details->banner_heading) }}" placeholder="Enter Banner Heading" required>
                                    ...
                                    <div class="col-xxl-4 col-sm-12">
                                        ...
                                        <div id="currentImageContainer">
                                            @if($bottoms_details->banner_image)
                                                <img id="currentBannerImage" src="{{ asset('/murupp/category/bottoms/' . $bottoms_details->banner_image) }}" alt="Current Banner Image" style="max-height: 100px; border: 1px solid #ddd; padding: 5px;">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 text-end">
                                        <a href="{{ route('bottoms.index') }}" class="btn btn-danger px-4">Cancel</a>
