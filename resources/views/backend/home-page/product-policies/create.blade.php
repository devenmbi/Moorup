        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Product Policies Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Product Policies</li>
                </ol>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('product-policies.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf

                                    <!-- Policy Heading-->
                                    <div class="col-xxl-4 col-sm-6">
                                        <label class="form-label" for="heading">Policy Heading <span class="txt-danger">*</span></label>
                                        <input class="form-control" id="heading" type="text" name="heading" placeholder="Enter Policy Heading" required>
                                     ...
                                     <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="image_title" type="text" name="image_title" placeholder="Enter Policy Description" required>
